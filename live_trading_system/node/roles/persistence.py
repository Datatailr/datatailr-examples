...
The on-disk layout (see :mod:`live_trading_system.persistence.parquet_io`)
is::
...
from live_trading_system.persistence.parquet_io import (
...
log = logging.getLogger("live_trading_system.persistence_sink")
