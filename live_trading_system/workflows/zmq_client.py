...
log = logging.getLogger("live_trading_system.workflows.zmq_client")

DEFAULT_PORT = int(os.environ.get("LIVE_TRADING_SYSTEM_PORT", "8080"))
...
def broadcast(
    ...
    *,
    ...
    fields populate :class:`~live_trading_system.node.messages_pb2.SystemEvent`.
...
def sample_events(
    ...
    """
    from live_trading_system.dashboard.app import _payload_to_dict  # local import
