"""Deploy the reactive-graph workflows on Datatailr.
...
Usage::
    ...
    python reactive_graph/workflows_deploy.py warmup     # warm-up only
    python reactive_graph/workflows_deploy.py eod        # EOD only
    python reactive_graph/workflows_deploy.py warmup --local
...
from reactive_graph.workflows.eod import (  # noqa: E402
...
from reactive_graph.workflows.warmup import (  # noqa: E402
