"""Reactive-graph node entry point.
...
runs on top of :class:`reactive_graph.node.transport.ZmqNode`.
...
``NODE_ROLE``                  Module
============================  ===========================================
``market-feed``                :mod:`reactive_graph.node.roles.market_feed`
``analytics``                  :mod:`reactive_graph.node.roles.analytics`
``signal-engine``              :mod:`reactive_graph.node.roles.signals`
``risk-engine``                :mod:`reactive_graph.node.roles.risk`
``execution-simulator``        :mod:`reactive_graph.node.roles.execution`
``notification-bus``           :mod:`reactive_graph.node.roles.bus`
``persistence-sink``           :mod:`reactive_graph.node.roles.persistence`
============================  ===========================================
...
from reactive_graph.node.transport import ZmqNode, parse_upstreams
from reactive_graph.node.roles import (
