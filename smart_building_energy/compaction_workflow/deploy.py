...
from smart_building_energy.compaction_workflow.tasks import (
    DEFAULT_BASE_PREFIX,
    DEFAULT_DATASETS,
...
BASE_PREFIX = os.environ.get("ENERGY_BLOB_PREFIX", DEFAULT_BASE_PREFIX)
...
@workflow(
    name="Energy Lake Hourly Compaction",
    ...
    env_vars={
        "ENERGY_BLOB_PREFIX": BASE_PREFIX,
        "COMPACTION_DATASETS": DATASETS,
